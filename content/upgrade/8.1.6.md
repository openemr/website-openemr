---
title: "Upgrading to OpenEMR 8.1.6"
version: "8.1.6"
---

{{< release-status version="8.1.6" >}}

# Upgrading to OpenEMR 8.1.6
...
1. Download the [openemr-8.1.6.tar.gz](https://sourceforge.net/projects/openemr/files/OpenEMR%20Current/8.1.6/openemr-8.1.6.tar.gz/download) tarball.
2. Extract the tarball alongside the existing installation; do not overwrite
   the existing `sites/` directory.
3. Browse to `https://your-server/openemr-8.1.6/sql_upgrade.php` and run
   the upgrade.
...
- Review the [release notes](/release-notes/8.1.6/) for post-upgrade
  configuration steps.
