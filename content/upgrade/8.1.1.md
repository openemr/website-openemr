---
title: "Upgrading to OpenEMR 8.1.1"
version: "8.1.1"
---

{{< release-status version="8.1.1" >}}

# Upgrading to OpenEMR 8.1.1
...
1. Download the [openemr-8.1.1.tar.gz](https://github.com/openemr/openemr/releases/download/v8_1_1/openemr-8.1.1.tar.gz) tarball.
2. Extract the tarball alongside the existing installation; do not overwrite
   the existing `sites/` directory.
3. Browse to `https://your-server/openemr-8.1.1/sql_upgrade.php` and run
   the upgrade.
...
- Review the [release notes](/release-notes/8.1.1/) for post-upgrade
  configuration steps.
